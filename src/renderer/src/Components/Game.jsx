    ...
    <div> 
      <div style={{ padding: '10px' }}> 
        ...
        <Row className="grid-row">
          ...
          <button className="button" onClick={() => sendDataToUnity(0)}>Hot Dog</button>
          </Col>
          <Col className="grid-col"><button className="button" onClick={() => sendDataToUnity(1)}>Hamburger</button></Col>
          
          <Col className="grid-col"><button className="button" onClick={() => sendDataToUnity(2)}>Pizza</button></Col>
          <Col className="grid-col"><button className="button" onClick={() => sendDataToUnity(3)}>Chicken</button></Col>
          <Col className="grid-col"><button className="button" onClick={() => sendDataToUnity(4)}>Fish</button></Col>
          <Col className="grid-col"><button className="button" onClick={() => sendDataToUnity(5)}>Fry</button></Col>
